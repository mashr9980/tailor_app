...
class AppointmentsScreenState extends State<NewAppointment> {
  var lan=GetStorage();
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title:lan.read("status")=="Arabic"?Text("رأي الزبون",style: appbartext):const Text("Schedule Appointment",style: appbartext,),
            actions: [
              Container(
                  padding: EdgeInsets.all(5),
                  height: 35,
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Center(
                      child: Text("Schedule Appointment",style: buttontext,),
                    ),
                  ),
                ),
