              ...
              children: [
                ...
                Container(
                  ...
                  child: Obx(
                        ...
                        orders.loading_search.isTrue?Center(child:Loader()): orders.data_search_phone.length==0?Center(child:Text("You do not have any orders with this number",style: buttontext1,)):ListView.builder(
                            physics:  BouncingScrollPhysics(),
                            shrinkWrap: true,
                            padding: EdgeInsets.only(top: 10,bottom: 20),
                            itemCount: orders.data_search_phone.length,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        SizedBox(height: 10,),
                                        Text("${orders.data_search_phone.value[index]['name']}",style: boldtext,),
                                        SizedBox(height: 5,),
                                        Text("${orders.data_search_phone.value[index]['phone']}",style: mediumsubheadingtext,),
                                        SizedBox(height: 5,),
                                        Text("Due Balance: ${orders.data_search_phone.value[index]['due']}",style: mediumsubredtext,),
                                        SizedBox(height: 5,),
                                        Text("Order ID: ${orders.data_search_phone.value[index]['id']}",style: boldtext,),
                                        SizedBox(height: 5,),
                                        Text("Delivery Date: ${orders.data_search_phone.value[index]['deliver_date']}",style: mediumsubheadingtext,),
                                        SizedBox(height: 5,),
                                      ],
                                    ),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                              ...
                                              child: Center(
                                                child: Directionality(
                                                  ...
                                                  child: CoolDropdown(
                                                    ...
                                                    defaultValue: dropdownprogress[int.parse(orders.data_search_phone.value[index]['status'])-1],
                                                    isResultLabel: true,
                                                    gap: 4,
                                                    ...
                                                    unselectedItemTS:const TextStyle(
                                                        ...
                                                        fontFamily: "Poppins"),
                                                    onChange: (a) async {
                                                      await orders.change_order(orders.data_search_phone.value[index]['id'],a["value"]);
                                            ...
                                            InkWell(
                                              onTap: ()async{
                                                var response = await flutterShareMe.shareToWhatsApp(msg: "Your Order # ${orders.data_search_phone.value[index]['id']} \n Name ${orders.data_search_phone.value[index]['name']} \n Deliver Date: ${orders.data_search_phone.value[index]['deliver_date']}\nBalance Due ${orders.data_search_phone.value[index]['due']}\n Status ${progress[int.parse(orders.data_search_phone.value[index]['status'])-1]}");
                                                // var response = await flutterShareMe.shareToWhatsApp(msg: "Your Order # ${orders.data_search_phone.value[index]['id']} Deliver Date: ${orders.data_search_phone.value[index]['deliver_date']}");
                                                // Share.whatsapp_personal;
                                              },
                                              child: Container(
                            ...
                            :orders.loading.isTrue?Center(child:Loader()): orders.data_my.length==0?Center(child:Text("You do not have any orders yet",style: buttontext1,)):ListView.builder(
                        physics:  BouncingScrollPhysics(),
                        shrinkWrap: true,
                        padding: EdgeInsets.only(top: 10,bottom: 20),
